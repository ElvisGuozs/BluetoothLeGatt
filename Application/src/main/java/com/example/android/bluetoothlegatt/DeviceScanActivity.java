...
public class DeviceScanActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra(DeviceControlActivity.EXTRAS_DEVICE_NAME, device.getBluetoothDevice().getName());
        intent.putExtra(DeviceControlActivity.EXTRAS_DEVICE_ADDRESS, device.getBluetoothDevice().getAddress());
        if (mScanning) {
        ...
        public void onLeScan(final BluetoothDevice device, final int rssi, byte[] scanRecord) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (myBluetoothDeviceMap == null) myBluetoothDeviceMap = new HashMap<>();
                    if (myBluetoothDeviceMap.containsKey(device.getAddress())) {
                        myBluetoothDevice = myBluetoothDeviceMap.get(device.getAddress());
                        myBluetoothDevice.setRssi(rssi);
                    } else {
                        myBluetoothDevice = new MyBluetoothDevice(device, rssi);
                        myBluetoothDeviceMap.put(device.getAddress(), myBluetoothDevice);
                    }
